...
export const PROTECTION_SETTING_DEFINITIONS = [
  ...
  { key: 'self_break_even_activation_percent', defaultValue: '1', kind: 'percent' },
  { key: 'self_trailing_activation_percent', defaultValue: '0.75', kind: 'percent' },
  { key: 'self_trailing_step_percent', defaultValue: '0.5', kind: 'percent' },
...
export const DEFAULT_PROTECTION_THRESHOLD_SETTINGS: ProtectionThresholdSettings = {
  ...
  selfBreakEvenActivationPercent: 1,
  selfTrailingActivationPercent: 0.75,
  selfTrailingStepPercent: 0.5,
